          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <section className="md:col-span-12 mt-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/goals" className="text-primary text-sm font-bold hover:underline">
                  + Add New Vault
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="glass-panel p-6 rounded-xl border border-outline-variant/10 overflow-hidden relative group">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-surface-container-highest flex items-center justify-center text-tertiary border border-outline-variant/20 shadow-xl group-hover:scale-105 transition-transform duration-500">
                      ...
                      <div>
                        <h3 className="font-headline font-bold text-white">Stablecoin Sanctuary</h3>
                        <span className="text-xs text-on-surface-variant">Low Risk</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg font-bold text-white">$18,000.00</div>
                      <div className="text-xs text-tertiary font-bold flex items-center justify-end gap-1"><IconArrowUpward size={12}/> 8.2% APR</div>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <Link href="/dashboard/strategy" className="flex-1 py-3 rounded-xl bg-surface-container-highest text-center text-sm font-bold hover:bg-surface-bright transition-colors border border-outline-variant/10">
